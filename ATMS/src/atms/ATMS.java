...
public class ATMS extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.getScene().getRoot().setStyle(configReader.getBaseStyle());
    }
    ...
    private Scene createLoginScene(Stage primaryStage) {
        ...
        loginButton.setOnAction(e -> {
            ...
            if (loggedInUser != null) {
                ...
                primaryStage.setScene(createAccountSelectionScene(primaryStage));
            } else {
    ...
    private Scene createAccountSelectionScene(Stage primaryStage) {
        ...
        continueButton.setOnAction(e -> {
            ...
            primaryStage.setScene(createMainScene(primaryStage, true));
        });
    ...
    private Scene createMainScene(Stage primaryStage, boolean showBackButton) {
        ...
        if (currentUser != null && currentUser.getCurrentAccount() != null) {
            ...
            withdrawButton.setOnAction(e -> {
                ...
                if (result.isPresent()) {
                    try {
                        double amountToWithdraw = Double.parseDouble(result.get());
            ...
            if (showBackButton) {
                ...
                backButton.setOnAction(e -> primaryStage.setScene(createAccountSelectionScene(primaryStage)));
            ...
            primaryStage.setScene(createAccountSelectionScene(primaryStage));
            return createAccountSelectionScene(primaryStage);
        }
    }
